...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MoveTurtle_Goal_message_member_array[4] = {
  {
    "linear_vel_x",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_interfaces::action::MoveTurtle_Goal, linear_vel_y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MoveTurtle_Feedback_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_interfaces::action::MoveTurtle_Feedback, current_position),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
void MoveTurtle_SendGoal_Event_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) my_robot_interfaces::action::MoveTurtle_SendGoal_Event(_init);
}

void MoveTurtle_SendGoal_Event_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_robot_interfaces::action::MoveTurtle_SendGoal_Event *>(message_memory);
  typed_message->~MoveTurtle_SendGoal_Event();
}

size_t size_function__MoveTurtle_SendGoal_Event__request(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<my_robot_interfaces::action::MoveTurtle_SendGoal_Request> *>(untyped_member);
  return member->size();
}

const void * get_const_function__MoveTurtle_SendGoal_Event__request(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<my_robot_interfaces::action::MoveTurtle_SendGoal_Request> *>(untyped_member);
  return &member[index];
}

void * get_function__MoveTurtle_SendGoal_Event__request(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<my_robot_interfaces::action::MoveTurtle_SendGoal_Request> *>(untyped_member);
  return &member[index];
}

void fetch_function__MoveTurtle_SendGoal_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const my_robot_interfaces::action::MoveTurtle_SendGoal_Request *>(
    get_const_function__MoveTurtle_SendGoal_Event__request(untyped_member, index));
  auto & value = *reinterpret_cast<my_robot_interfaces::action::MoveTurtle_SendGoal_Request *>(untyped_value);
  value = item;
}

void assign_function__MoveTurtle_SendGoal_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<my_robot_interfaces::action::MoveTurtle_SendGoal_Request *>(
    get_function__MoveTurtle_SendGoal_Event__request(untyped_member, index));
  const auto & value = *reinterpret_cast<const my_robot_interfaces::action::MoveTurtle_SendGoal_Request *>(untyped_value);
  item = value;
}

void resize_function__MoveTurtle_SendGoal_Event__request(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<my_robot_interfaces::action::MoveTurtle_SendGoal_Request> *>(untyped_member);
  member->resize(size);
...
size_t size_function__MoveTurtle_SendGoal_Event__response(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<my_robot_interfaces::action::MoveTurtle_SendGoal_Response> *>(untyped_member);
  return member->size();
}

const void * get_const_function__MoveTurtle_SendGoal_Event__response(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<my_robot_interfaces::action::MoveTurtle_SendGoal_Response> *>(untyped_member);
  return &member[index];
}

void * get_function__MoveTurtle_SendGoal_Event__response(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<my_robot_interfaces::action::MoveTurtle_SendGoal_Response> *>(untyped_member);
  return &member[index];
}

void fetch_function__MoveTurtle_SendGoal_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const my_robot_interfaces::action::MoveTurtle_SendGoal_Response *>(
    get_const_function__MoveTurtle_SendGoal_Event__response(untyped_member, index));
  auto & value = *reinterpret_cast<my_robot_interfaces::action::MoveTurtle_SendGoal_Response *>(untyped_value);
  value = item;
}

void assign_function__MoveTurtle_SendGoal_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<my_robot_interfaces::action::MoveTurtle_SendGoal_Response *>(
    get_function__MoveTurtle_SendGoal_Event__response(untyped_member, index));
  const auto & value = *reinterpret_cast<const my_robot_interfaces::action::MoveTurtle_SendGoal_Response *>(untyped_value);
  item = value;
}

void resize_function__MoveTurtle_SendGoal_Event__response(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<my_robot_interfaces::action::MoveTurtle_SendGoal_Response> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MoveTurtle_SendGoal_Event_message_member_array[3] = {
  {
    "info",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_interfaces::action::MoveTurtle_SendGoal_Event, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<my_robot_interfaces::action::MoveTurtle_SendGoal_Request>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(my_robot_interfaces::action::MoveTurtle_SendGoal_Event, request),  // bytes offset in struct
    nullptr,  // default value
    size_function__MoveTurtle_SendGoal_Event__request,  // size() function pointer
    get_const_function__MoveTurtle_SendGoal_Event__request,  // get_const(index) function pointer
    get_function__MoveTurtle_SendGoal_Event__request,  // get(index) function pointer
    fetch_function__MoveTurtle_SendGoal_Event__request,  // fetch(index, &value) function pointer
    assign_function__MoveTurtle_SendGoal_Event__request,  // assign(index, value) function pointer
    resize_function__MoveTurtle_SendGoal_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<my_robot_interfaces::action::MoveTurtle_SendGoal_Response>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(my_robot_interfaces::action::MoveTurtle_SendGoal_Event, response),  // bytes offset in struct
    nullptr,  // default value
    size_function__MoveTurtle_SendGoal_Event__response,  // size() function pointer
    get_const_function__MoveTurtle_SendGoal_Event__response,  // get_const(index) function pointer
    get_function__MoveTurtle_SendGoal_Event__response,  // get(index) function pointer
    fetch_function__MoveTurtle_SendGoal_Event__response,  // fetch(index, &value) function pointer
    assign_function__MoveTurtle_SendGoal_Event__response,  // assign(index, value) function pointer
    resize_function__MoveTurtle_SendGoal_Event__response  // resize(index) function pointer
  }
};

static const ::rosidl_typesupport_introspection_cpp::MessageMembers MoveTurtle_SendGoal_Event_message_members = {
  "my_robot_interfaces::action",  // message namespace
  "MoveTurtle_SendGoal_Event",  // message name
  3,  // number of fields
  sizeof(my_robot_interfaces::action::MoveTurtle_SendGoal_Event),
  false,  // has_any_key_member_
  MoveTurtle_SendGoal_Event_message_member_array,  // message members
  MoveTurtle_SendGoal_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  MoveTurtle_SendGoal_Event_fini_function  // function to terminate message instance (will not free memory)
};

static const rosidl_message_type_support_t MoveTurtle_SendGoal_Event_message_type_support_handle = {
  ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  &MoveTurtle_SendGoal_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<my_robot_interfaces::action::MoveTurtle_SendGoal_Event>()
{
  return &::my_robot_interfaces::action::rosidl_typesupport_introspection_cpp::MoveTurtle_SendGoal_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_robot_interfaces, action, MoveTurtle_SendGoal_Event)() {
  return &::my_robot_interfaces::action::rosidl_typesupport_introspection_cpp::MoveTurtle_SendGoal_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t MoveTurtle_SendGoal_service_type_support_handle = {
  ...
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<my_robot_interfaces::action::MoveTurtle_SendGoal_Request>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<my_robot_interfaces::action::MoveTurtle_SendGoal_Response>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<my_robot_interfaces::action::MoveTurtle_SendGoal_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<my_robot_interfaces::action::MoveTurtle_SendGoal>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<my_robot_interfaces::action::MoveTurtle_SendGoal>,
...
get_service_type_support_handle<my_robot_interfaces::action::MoveTurtle_SendGoal>()
{
    ...
    service_members->event_members_ == nullptr)
  {
    ...
    service_members->event_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::my_robot_interfaces::action::MoveTurtle_SendGoal_Event
      >()->data
      );
  }
...
void MoveTurtle_GetResult_Event_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) my_robot_interfaces::action::MoveTurtle_GetResult_Event(_init);
}

void MoveTurtle_GetResult_Event_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_robot_interfaces::action::MoveTurtle_GetResult_Event *>(message_memory);
  typed_message->~MoveTurtle_GetResult_Event();
}

size_t size_function__MoveTurtle_GetResult_Event__request(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<my_robot_interfaces::action::MoveTurtle_GetResult_Request> *>(untyped_member);
  return member->size();
}

const void * get_const_function__MoveTurtle_GetResult_Event__request(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<my_robot_interfaces::action::MoveTurtle_GetResult_Request> *>(untyped_member);
  return &member[index];
}

void * get_function__MoveTurtle_GetResult_Event__request(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<my_robot_interfaces::action::MoveTurtle_GetResult_Request> *>(untyped_member);
  return &member[index];
}

void fetch_function__MoveTurtle_GetResult_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const my_robot_interfaces::action::MoveTurtle_GetResult_Request *>(
    get_const_function__MoveTurtle_GetResult_Event__request(untyped_member, index));
  auto & value = *reinterpret_cast<my_robot_interfaces::action::MoveTurtle_GetResult_Request *>(untyped_value);
  value = item;
}

void assign_function__MoveTurtle_GetResult_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<my_robot_interfaces::action::MoveTurtle_GetResult_Request *>(
    get_function__MoveTurtle_GetResult_Event__request(untyped_member, index));
  const auto & value = *reinterpret_cast<const my_robot_interfaces::action::MoveTurtle_GetResult_Request *>(untyped_value);
  item = value;
}

void resize_function__MoveTurtle_GetResult_Event__request(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<my_robot_interfaces::action::MoveTurtle_GetResult_Request> *>(untyped_member);
  member->resize(size);
...
size_t size_function__MoveTurtle_GetResult_Event__response(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<my_robot_interfaces::action::MoveTurtle_GetResult_Response> *>(untyped_member);
  return member->size();
}

const void * get_const_function__MoveTurtle_GetResult_Event__response(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<my_robot_interfaces::action::MoveTurtle_GetResult_Response> *>(untyped_member);
  return &member[index];
}

void * get_function__MoveTurtle_GetResult_Event__response(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<my_robot_interfaces::action::MoveTurtle_GetResult_Response> *>(untyped_member);
  return &member[index];
}

void fetch_function__MoveTurtle_GetResult_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const my_robot_interfaces::action::MoveTurtle_GetResult_Response *>(
    get_const_function__MoveTurtle_GetResult_Event__response(untyped_member, index));
  auto & value = *reinterpret_cast<my_robot_interfaces::action::MoveTurtle_GetResult_Response *>(untyped_value);
  value = item;
}

void assign_function__MoveTurtle_GetResult_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<my_robot_interfaces::action::MoveTurtle_GetResult_Response *>(
    get_function__MoveTurtle_GetResult_Event__response(untyped_member, index));
  const auto & value = *reinterpret_cast<const my_robot_interfaces::action::MoveTurtle_GetResult_Response *>(untyped_value);
  item = value;
}

void resize_function__MoveTurtle_GetResult_Event__response(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<my_robot_interfaces::action::MoveTurtle_GetResult_Response> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MoveTurtle_GetResult_Event_message_member_array[3] = {
  {
    "info",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_interfaces::action::MoveTurtle_GetResult_Event, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<my_robot_interfaces::action::MoveTurtle_GetResult_Request>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(my_robot_interfaces::action::MoveTurtle_GetResult_Event, request),  // bytes offset in struct
    nullptr,  // default value
    size_function__MoveTurtle_GetResult_Event__request,  // size() function pointer
    get_const_function__MoveTurtle_GetResult_Event__request,  // get_const(index) function pointer
    get_function__MoveTurtle_GetResult_Event__request,  // get(index) function pointer
    fetch_function__MoveTurtle_GetResult_Event__request,  // fetch(index, &value) function pointer
    assign_function__MoveTurtle_GetResult_Event__request,  // assign(index, value) function pointer
    resize_function__MoveTurtle_GetResult_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<my_robot_interfaces::action::MoveTurtle_GetResult_Response>(),  // members of sub message
    false,  // is key
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(my_robot_interfaces::action::MoveTurtle_GetResult_Event, response),  // bytes offset in struct
    nullptr,  // default value
    size_function__MoveTurtle_GetResult_Event__response,  // size() function pointer
    get_const_function__MoveTurtle_GetResult_Event__response,  // get_const(index) function pointer
    get_function__MoveTurtle_GetResult_Event__response,  // get(index) function pointer
    fetch_function__MoveTurtle_GetResult_Event__response,  // fetch(index, &value) function pointer
    assign_function__MoveTurtle_GetResult_Event__response,  // assign(index, value) function pointer
    resize_function__MoveTurtle_GetResult_Event__response  // resize(index) function pointer
  }
};

static const ::rosidl_typesupport_introspection_cpp::MessageMembers MoveTurtle_GetResult_Event_message_members = {
  "my_robot_interfaces::action",  // message namespace
  "MoveTurtle_GetResult_Event",  // message name
  3,  // number of fields
  sizeof(my_robot_interfaces::action::MoveTurtle_GetResult_Event),
  false,  // has_any_key_member_
  MoveTurtle_GetResult_Event_message_member_array,  // message members
  MoveTurtle_GetResult_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  MoveTurtle_GetResult_Event_fini_function  // function to terminate message instance (will not free memory)
};

static const rosidl_message_type_support_t MoveTurtle_GetResult_Event_message_type_support_handle = {
  ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  &MoveTurtle_GetResult_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<my_robot_interfaces::action::MoveTurtle_GetResult_Event>()
{
  return &::my_robot_interfaces::action::rosidl_typesupport_introspection_cpp::MoveTurtle_GetResult_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_robot_interfaces, action, MoveTurtle_GetResult_Event)() {
  return &::my_robot_interfaces::action::rosidl_typesupport_introspection_cpp::MoveTurtle_GetResult_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t MoveTurtle_GetResult_service_type_support_handle = {
  ...
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<my_robot_interfaces::action::MoveTurtle_GetResult_Request>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<my_robot_interfaces::action::MoveTurtle_GetResult_Response>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<my_robot_interfaces::action::MoveTurtle_GetResult_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<my_robot_interfaces::action::MoveTurtle_GetResult>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<my_robot_interfaces::action::MoveTurtle_GetResult>,
...
get_service_type_support_handle<my_robot_interfaces::action::MoveTurtle_GetResult>()
{
    ...
    service_members->event_members_ == nullptr)
  {
    ...
    service_members->event_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::my_robot_interfaces::action::MoveTurtle_GetResult_Event
      >()->data
      );
  }
  // finally return the properly initialized service_type_support handle
