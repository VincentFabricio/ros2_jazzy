...
enum
{
  my_robot_interfaces__action__MoveTurtle_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  my_robot_interfaces__action__MoveTurtle_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/MoveTurtle in the package my_robot_interfaces.
typedef struct my_robot_interfaces__action__MoveTurtle_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  my_robot_interfaces__action__MoveTurtle_SendGoal_Request__Sequence request;
  my_robot_interfaces__action__MoveTurtle_SendGoal_Response__Sequence response;
} my_robot_interfaces__action__MoveTurtle_SendGoal_Event;

// Struct for a sequence of my_robot_interfaces__action__MoveTurtle_SendGoal_Event.
typedef struct my_robot_interfaces__action__MoveTurtle_SendGoal_Event__Sequence
{
...
enum
{
  my_robot_interfaces__action__MoveTurtle_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  my_robot_interfaces__action__MoveTurtle_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/MoveTurtle in the package my_robot_interfaces.
typedef struct my_robot_interfaces__action__MoveTurtle_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  my_robot_interfaces__action__MoveTurtle_GetResult_Request__Sequence request;
  my_robot_interfaces__action__MoveTurtle_GetResult_Response__Sequence response;
} my_robot_interfaces__action__MoveTurtle_GetResult_Event;

// Struct for a sequence of my_robot_interfaces__action__MoveTurtle_GetResult_Event.
typedef struct my_robot_interfaces__action__MoveTurtle_GetResult_Event__Sequence
{
