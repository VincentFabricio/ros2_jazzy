...
// IWYU pragma: private, include "my_robot_interfaces/action/move_turtle.hpp"
...
struct MoveTurtle_Goal_
{
  ...
  using _linear_vel_y_type =
    double;
  _linear_vel_y_type linear_vel_y;
  ...
  Type & set__linear_vel_y(
    const double & _arg)
  {
    this->linear_vel_y = _arg;
    return *this;
  }
  ...
  bool operator==(const MoveTurtle_Goal_ & other) const
  {
    ...
    if (this->linear_vel_y != other.linear_vel_y) {
      return false;
    }
...
#ifndef _WIN32
# define DEPRECATED__my_robot_interfaces__action__MoveTurtle_SendGoal_Event __attribute__((deprecated))
#else
# define DEPRECATED__my_robot_interfaces__action__MoveTurtle_SendGoal_Event __declspec(deprecated)
#endif
...
// message struct
template<class ContainerAllocator>
struct MoveTurtle_SendGoal_Event_
{
  using Type = MoveTurtle_SendGoal_Event_<ContainerAllocator>;

  explicit MoveTurtle_SendGoal_Event_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_init)
  {
    (void)_init;
  }

  explicit MoveTurtle_SendGoal_Event_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_alloc, _init)
  {
    (void)_init;
  }
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<my_robot_interfaces::action::MoveTurtle_SendGoal_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<my_robot_interfaces::action::MoveTurtle_SendGoal_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<my_robot_interfaces::action::MoveTurtle_SendGoal_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<my_robot_interfaces::action::MoveTurtle_SendGoal_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<my_robot_interfaces::action::MoveTurtle_SendGoal_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<my_robot_interfaces::action::MoveTurtle_SendGoal_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<my_robot_interfaces::action::MoveTurtle_SendGoal_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<my_robot_interfaces::action::MoveTurtle_SendGoal_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    my_robot_interfaces::action::MoveTurtle_SendGoal_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const my_robot_interfaces::action::MoveTurtle_SendGoal_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<my_robot_interfaces::action::MoveTurtle_SendGoal_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<my_robot_interfaces::action::MoveTurtle_SendGoal_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      my_robot_interfaces::action::MoveTurtle_SendGoal_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<my_robot_interfaces::action::MoveTurtle_SendGoal_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      my_robot_interfaces::action::MoveTurtle_SendGoal_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<my_robot_interfaces::action::MoveTurtle_SendGoal_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<my_robot_interfaces::action::MoveTurtle_SendGoal_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<my_robot_interfaces::action::MoveTurtle_SendGoal_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__my_robot_interfaces__action__MoveTurtle_SendGoal_Event
    std::shared_ptr<my_robot_interfaces::action::MoveTurtle_SendGoal_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__my_robot_interfaces__action__MoveTurtle_SendGoal_Event
    std::shared_ptr<my_robot_interfaces::action::MoveTurtle_SendGoal_Event_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const MoveTurtle_SendGoal_Event_ & other) const
  {
...
// alias to use template instance with default allocator
using MoveTurtle_SendGoal_Event =
  my_robot_interfaces::action::MoveTurtle_SendGoal_Event_<std::allocator<void>>;
...
struct MoveTurtle_SendGoal
{
  ...
  using Event = my_robot_interfaces::action::MoveTurtle_SendGoal_Event;
};
...
#ifndef _WIN32
# define DEPRECATED__my_robot_interfaces__action__MoveTurtle_GetResult_Event __attribute__((deprecated))
#else
# define DEPRECATED__my_robot_interfaces__action__MoveTurtle_GetResult_Event __declspec(deprecated)
#endif
...
// message struct
template<class ContainerAllocator>
struct MoveTurtle_GetResult_Event_
{
  using Type = MoveTurtle_GetResult_Event_<ContainerAllocator>;

  explicit MoveTurtle_GetResult_Event_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_init)
  {
    (void)_init;
  }

  explicit MoveTurtle_GetResult_Event_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_alloc, _init)
  {
    (void)_init;
  }
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<my_robot_interfaces::action::MoveTurtle_GetResult_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<my_robot_interfaces::action::MoveTurtle_GetResult_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<my_robot_interfaces::action::MoveTurtle_GetResult_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<my_robot_interfaces::action::MoveTurtle_GetResult_Response_<ContainerAllocator>>>;
  _response_type response;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<my_robot_interfaces::action::MoveTurtle_GetResult_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<my_robot_interfaces::action::MoveTurtle_GetResult_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<my_robot_interfaces::action::MoveTurtle_GetResult_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<my_robot_interfaces::action::MoveTurtle_GetResult_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    my_robot_interfaces::action::MoveTurtle_GetResult_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const my_robot_interfaces::action::MoveTurtle_GetResult_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<my_robot_interfaces::action::MoveTurtle_GetResult_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<my_robot_interfaces::action::MoveTurtle_GetResult_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      my_robot_interfaces::action::MoveTurtle_GetResult_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<my_robot_interfaces::action::MoveTurtle_GetResult_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      my_robot_interfaces::action::MoveTurtle_GetResult_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<my_robot_interfaces::action::MoveTurtle_GetResult_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<my_robot_interfaces::action::MoveTurtle_GetResult_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<my_robot_interfaces::action::MoveTurtle_GetResult_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__my_robot_interfaces__action__MoveTurtle_GetResult_Event
    std::shared_ptr<my_robot_interfaces::action::MoveTurtle_GetResult_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__my_robot_interfaces__action__MoveTurtle_GetResult_Event
    std::shared_ptr<my_robot_interfaces::action::MoveTurtle_GetResult_Event_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const MoveTurtle_GetResult_Event_ & other) const
  {
    if (this->info != other.info) {
      return false;
    }
...
// alias to use template instance with default allocator
using MoveTurtle_GetResult_Event =
  my_robot_interfaces::action::MoveTurtle_GetResult_Event_<std::allocator<void>>;
...
struct MoveTurtle_GetResult
{
  ...
  using Event = my_robot_interfaces::action::MoveTurtle_GetResult_Event;
};
