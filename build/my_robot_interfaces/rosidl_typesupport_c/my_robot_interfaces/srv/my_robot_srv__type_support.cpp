...
static const _MyRobotSrv_Request_type_support_symbol_names_t _MyRobotSrv_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces, srv, MyRobotSrv_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_robot_interfaces, srv, MyRobotSrv_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_robot_interfaces, srv, MyRobotSrv_Request)() {
  return &::my_robot_interfaces::srv::rosidl_typesupport_c::MyRobotSrv_Request_message_type_support_handle;
}
...
static const _MyRobotSrv_Response_type_support_symbol_names_t _MyRobotSrv_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces, srv, MyRobotSrv_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_robot_interfaces, srv, MyRobotSrv_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_robot_interfaces, srv, MyRobotSrv_Response)() {
  return &::my_robot_interfaces::srv::rosidl_typesupport_c::MyRobotSrv_Response_message_type_support_handle;
}
...
static const _MyRobotSrv_Event_type_support_symbol_names_t _MyRobotSrv_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces, srv, MyRobotSrv_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_robot_interfaces, srv, MyRobotSrv_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_robot_interfaces, srv, MyRobotSrv_Event)() {
  return &::my_robot_interfaces::srv::rosidl_typesupport_c::MyRobotSrv_Event_message_type_support_handle;
}
...
static const _MyRobotSrv_type_support_symbol_names_t _MyRobotSrv_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interfaces, srv, MyRobotSrv)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_robot_interfaces, srv, MyRobotSrv)),
  }
};
...
static const rosidl_service_type_support_t MyRobotSrv_service_type_support_handle = {
  ...
  &MyRobotSrv_Request_message_type_support_handle,
  &MyRobotSrv_Response_message_type_support_handle,
  &MyRobotSrv_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, my_robot_interfaces, srv, MyRobotSrv)() {
  return &::my_robot_interfaces::srv::rosidl_typesupport_c::MyRobotSrv_service_type_support_handle;
}
